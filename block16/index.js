...
function logNames(items) {
  // TODO: use `forEach`
  names = []
  items.forEach(currentItem => names.push(currentItem.name))
  return names;
}
...
function getUppercaseNames(items) {
  // TODO: use `map`
  // names = logNames(items)
  // return names.map(currentItem => currentItem.toUpperCase())
  return logNames(items).map(currentItem => currentItem.toUpperCase())
}
...
console.log("Here are the names again in all uppercase:", getUppercaseNames(INVENTORY));
